...
/**
 * This is a temporary implementation for inline modeling prototyping which includes
 * logic copied from pdi-agile-bi-plugin: org.pentaho.agilebi.spoon.SpoonModelerWorkspaceHelper.
 * It is needed to avoid a circular dependency issue. This will be decoupled from Analyzer
 * and become part of the modeling API.
 */
public class ModelingWorkspaceHelper extends BaseModelerWorkspaceHelper implements IModelerWorkspaceHelper {
  ...
  public ModelingWorkspaceHelper() {
    this( initGeoContext() );
  }

  public ModelingWorkspaceHelper( GeoContext geoContext ) {
